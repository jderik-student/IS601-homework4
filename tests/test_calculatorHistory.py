...
def test_append(setup):
    ...
    assert CalculatorHistory.get_last_calculation() == calculation
...
def test_get_last_calculation(setup):
    ...
    assert last_calculation.a == Decimal('7') and last_calculation.b == Decimal('8') and last_calculation.operation.__name__ == "divide"
...
def test_find_by_operation(setup):
    ...
    assert len(add_operation) == 1
    assert len(subtract_operation) == 1
    assert len(multiply_operation) == 1
    assert len(divide_operation) == 1
...
def test_get_ith_calculation(setup):
    ...
    assert first_calculation.a == Decimal('1') and first_calculation.b == Decimal('2') and first_calculation.operation.__name__ == "add"
    assert second_calculation.a == Decimal('3') and second_calculation.b == Decimal('4') and second_calculation.operation.__name__ == "subtract"
    assert third_calculation.a == Decimal('5') and third_calculation.b == Decimal('6') and third_calculation.operation.__name__ == "multiply"
    assert fourth_calculation.a == Decimal('7') and fourth_calculation.b == Decimal('8') and fourth_calculation.operation.__name__ == "divide"
